...
#include "SystemModule.h"
	...
	DECLARE_EMBEDDED_MODULE(BSPDebugger)
	DECLARE_EMBEDDED_MODULE(EntityEditor)
	DECLARE_EMBEDDED_MODULE(FormationEditor)
	DECLARE_EMBEDDED_MODULE(GroundUnitTypes)
	DECLARE_EMBEDDED_MODULE(ParticleSystems)
	DECLARE_EMBEDDED_MODULE(PlayAreaElements)
	DECLARE_EMBEDDED_MODULE(ScenarioEditor)
	...
	BEGIN_EMBEDDED_MODULE_TABLE()
		...
		EMBEDDED_MODULE(BSPDebugger)
		EMBEDDED_MODULE(EntityEditor)
		EMBEDDED_MODULE(FormationEditor)
		EMBEDDED_MODULE(GroundUnitTypes)
		EMBEDDED_MODULE(ParticleSystems)
		EMBEDDED_MODULE(PlayAreaElements)
		EMBEDDED_MODULE(ScenarioEditor)
