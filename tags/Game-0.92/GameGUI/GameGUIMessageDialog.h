...
class CGameGUIMessageDialog: public CGameDialogBase, virtual public IGameGUIMessageDialog, virtual public IGameGUIButtonEvents
{
...
protected:
	...
	BEGIN_PROP_MAP(CGameGUIMessageDialog)
...
public:
	...
	void ShowMessage(IGameWindow *piParent,std::string sText,std::string sTitle,EMessageDialogType eType);


	CGameGUIMessageDialog(void);
	~CGameGUIMessageDialog(void);
};
