...
CEntityEditorObjectLabel::CEntityEditorObjectLabel(void)
{
...
void CEntityEditorObjectLabel::OnDrawBackground( IGenericRender *piRender )
{
...
void CEntityEditorObjectLabel::SetObject(IDesignObject *piObject)
{
	REL(m_piDesignObject);
	m_piDesignObject=ADD(piObject);
}

void CEntityEditorObjectLabel::DestroyWindow()
{
	REL(m_piDesignObject);
	CGameWindowBase::DestroyWindow();
}

bool CEntityEditorObjectLabel::InitWindow( IGameWindow *piParent,bool bPopup )
{
