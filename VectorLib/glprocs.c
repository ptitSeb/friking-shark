...
static void WINAPI InitGenFramebuffersEXT (GLsizei a, GLuint *b)
{
	void *extproc;
...
static void WINAPI InitDeleteFramebuffersEXT (GLsizei a,const GLuint *b)
{
	void *extproc;
...
static void WINAPI InitBindFramebufferEXT (GLenum a, GLuint b)
{
	void *extproc;
...
static void WINAPI InitFramebufferTexture2DEXT(GLenum a, GLenum b, GLenum c, GLuint d, GLint e)
{
	void *extproc;
...
static GLenum WINAPI InitCheckFramebufferStatusEXT(GLenum a)
{
	void *extproc;
