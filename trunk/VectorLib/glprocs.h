...
typedef struct {
  ...
  void (WINAPI *GenFramebuffersEXT) (GLsizei a, GLuint *b);
  void (WINAPI *DeleteFramebuffersEXT) (GLsizei, const GLuint *);
  void (WINAPI *BindFramebufferEXT) (GLenum, GLuint);
  void (WINAPI *FramebufferTexture2DEXT) (GLenum, GLenum, GLenum, GLuint, GLint);
  GLenum (WINAPI *CheckFramebufferStatusEXT) (GLenum);
  void (WINAPI *DeleteRenderbuffersEXT) (GLsizei n, const GLuint* renderbuffers);
  void (WINAPI *FramebufferRenderbufferEXT) (GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
  void (WINAPI *GenRenderbuffersEXT) (GLsizei n, GLuint* renderbuffers);
  void (WINAPI *BindRenderbufferEXT) (GLenum target, GLuint renderbuffer);
  void (WINAPI *RenderbufferStorageEXT)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
  void (WINAPI *GenerateMipmapEXT)(GLenum target);
