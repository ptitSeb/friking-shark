...
class CEntityEditorObjectListSelector: public CGameDialogBase, virtual public IEntityEditorObjectListSelector,virtual public IGameGUIListEvents
{
	std::string m_sTitle;
...
public:
	...
	CEntityEditorObjectListSelector(void);
	~CEntityEditorObjectListSelector(void);
};
