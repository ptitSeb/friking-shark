...
BEGIN_SYSTEM_MODULE(ScenarioEditor)
	...
	SYSTEM_MODULE_CLASS_FACTORY_ENTRY(CScenarioEditorObjectListSelector,"CScenarioEditorObjectListSelector")
	SYSTEM_MODULE_CLASS_FACTORY_ENTRY(CScenarioEditorObjectLabel,"CScenarioEditorObjectLabel")
END_SYSTEM_MODULE(ScenarioEditor)
